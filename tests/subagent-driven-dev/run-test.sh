...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superpowers-tests/$TIMESTAMP/executing-plans"
OUTPUT_DIR="$OUTPUT_BASE/$TEST_NAME"
mkdir -p "$OUTPUT_DIR"

echo "=== Executing Plans Test ==="
echo "Test: $TEST_NAME"
...
PROMPT="Execute this plan using superpowers:executing-plans. The plan is at: $PLAN_PATH"
